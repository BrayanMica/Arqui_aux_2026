...
DURACION_RIEGO = 10.0  # Segundos máximos para riego manual
BUZZER_FREQUENCY = 1000  # Hz para el buzzer (mayor volumen)
BUZZER_DUTY_CYCLE = 50  # Porcentaje PWM para buzzer (0-100), 50 es mayor volumen
